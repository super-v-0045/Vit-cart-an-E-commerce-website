    ...
    <div class="container">
        ...
        <div class="data">
            <div class="top">
                ...
                <a href="mobileChart.html"><button style="background-color: purple;">Selling of Mobile</button></a>
            ...
            <div class="body">
                ...
                <?php
                    ...
                    $rows = mysqli_query($conn, "SELECT * FROM products where category='mobile'");
                    ?>
                    <?php $i = 1; ?>
