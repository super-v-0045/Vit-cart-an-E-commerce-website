    ...
    <div class="container">
        ...
        <div class="data">
            <div class="top">
                ...
                <a href="Laptopchart.html"><button style="background-color: purple;">Selling of laptop</button></a>
                <p>ViT-Cart.com</p>
            </div>
            <div class="header">
                <p>BUY laptop</p>
            ...
            <div class="body">
                <div id="root">
                    ...
                    $rows = mysqli_query($conn, "SELECT * FROM products where category='laptop'");
                    ?>
                    <?php $i = 1; ?>
